...
function JinxShortInfo () {
  return (
    ...
    >
      <Image
        ...
        alt=''
      />
			<div className='sm:px-36 px-12 pt-28 pb-24  relative  '>
        <div>
          <div>
            <Image
  ...
  "'
            ...
            <div>
							...
							<div className='relative'>
								<p className='max-w-2xl relative text-sm font-mono bg-[#18181899] p-4 rounded-xl border-[1px] border-[#262626]'>
									A manic and impulsive criminal from Zaun, Jinx lives to wreak
            ...
            <div className='relative '>
              <video
                className='
                md:w-[350px] md:h-[350px] w-[300px] h-[300px] rounded-full
    object-cover 
    object-center z-0 border-8 border-pink-500
  "'
                disablePictureInPicture
            ...
            <video
              className='
               md:w-[400px] md:h-[400px] w-[350px] h-[350px]  absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 extra blur-[10px] z-[-1] rounded-full opacity-50
    object-cover
    object-center
  "'
              disablePictureInPicture
