  ...
  return (
    <div className="md:p-24 relative p-4   ">
            ...
            >
              ...
              <div className="p-4 flex flex-col gap-4">
                <div className="flex items-center gap-4 overflow-hidden">
                  ...
                  <div className=" flex">
                    <h3 className="text-white text-lg font-semibold w-lvw ">
                      {spell.name}
                    </h3>
                  </div>
                </div>
                ...
                <p
                  ...
                  dangerouslySetInnerHTML={{
                    __html: formatTooltip(spell.tooltip),
                  }}
                ></p>
              </div>
            </div>
      ...
      <Image
        ...
        width={1500}
        height={1200}
        className="absolute top-0 left-0 w-full h-full z-[-1] opacity-30 blur-md"
      />
