	...
	return (
		<div className='relative p-6 sm:p-20 flex flex-col gap-8 scroll overflow-x-hidden '>
			...
			<div className='flex flex-col md:flex-row gap-8 justify-between *:flex-1  '>
				<div className=' flex flex-col items-center md:items-start justify-end gap-4 '>
					<div className='flex flex-col items-center md:items-start justify-center  '>
						...
						<div className='flex flex-col items-center justify-center gap-4'>
							...
							<h1 className='z-10 text-[#c2e29c] fancy-animation text-8xl'>ZAUN</h1>
						</div>
						<h2 className='z-10 text-[#bddb98a9] fancy-animation text-4xl text-center sm:text-left'>Polluted undercity</h2>
						<div className='mt-8'>
							<div className='grid grid-cols-2 gap-2 *:text-center  ' >
								<div className='border border-[#544c3d] p-4 rounded '>
									<p className='text-xs'>
										Industrial oligarchy
									</p>
								</div>
								<div className='border border-[#6e624d] p-4 rounded '>
									<p className='text-xs'>
										Advanced Tech
									</p>
								</div><div className='border border-[#615744] p-4 rounded '>
									<p className='text-xs'>
										Exploit magic</p>
								</div><div className='border border-[#4A4336] p-4 rounded '>
									<p className='text-xs'>
										Urbanized (toxic)
									</p>
								</div>
				...
				<div className=' flex flex-col items-center justify-center  gap-8 w-full *:w-full  *:text-center relative text-[#b3d08f] max-w-3xl
				fancy-animation  group '>

					<div className='absolute top-0 right-0  '>
						<figure className='relative'>
							<div className='border-t border-[#c2e29c]  ml-[18px] mr-[18px] '></div>
							<div className='h-4 w-4 border rotate-45 absolute top-0 left-0 transform -translate-y-1/2 border-[#c2e29c] '><div className='flex items-center justify-center h-full group-hover:opacity-90 transition opacity-0'>
					...
					<p className='text-sm  py-6  '>
						...
						reflected from the stained glass of its industrial architecture. Zaun
						and Piltover were once united, but are now separate, yet symbiotic
						societies. Though it exists in perpetual smogged twilight, Zaun
						thrives, its people vibrant and its culture rich. Piltover’s wealth
						has allowed Zaun to develop in tandem; a dark mirror of the city
						above. Many of the goods coming to Piltover find their way into Zaun’s
						black markets, and hextech inventors who find the restrictions placed
						upon them in the city above too restrictive often find their dangerous
						researches welcomed in Zaun. Unfettered development of volatile
						technologies and reckless industry has rendered whole swathes of Zaun
						polluted and dangerous. Streams of toxic runoff stagnate in the
						city’s lower reaches, but even here people find a way to exist and
						prosper.
					</p>
					...
					<div className='group-hover:!w-5/6 !w-4/6 transition-all transform -translate-x-1/2 h-full absolute top-0 left-1/2 bg-[#c2e29c] z-[-1] opacity-5 '>

					</div>
				</div>
			</div>

			<Hr ><h1 className='text-2xl'> Local Legends </h1></Hr>
					...
					{Array(14)
						...
						.map((_, index) => (
							...
							<SwiperSlide key={index}>
								<Tilt options={optionsSwiper} className='transition-transform duration-[100ms] ease-in-out'>
			...
			<Hr ><h1 className='text-2xl'> Innovations and Terminologies</h1></Hr>
			...
			<div className='relative flex flex-col gap-16 z-10'>
				...
				<div className='relative flex flex-col gap-12'>
					{[
						...
						<div
							key={index}
							className={`flex gap-4 transition-all hover:gap-0  flex-col md:flex-row ${index % 2 === 0 ? 'md:flex-row' : 'md:flex-row-reverse'} items-center group relative`}
						>
							{/* Изображение */}
							<Tilt options={optionsTerms} className='relative w-full transition-transform duration-[100ms] ease-in-out md:w-1/2 h-64 md:h-96'>
								<div >
									<Image
										src={item.img}
										alt={`Term ${index + 1}`}
							...
							>
								...
								<div
									className={`absolute  w-5 h-5 border border-[#938469] bg-[#414141] rotate-45 ${index % 2 === 0
