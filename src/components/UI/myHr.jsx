...
function Hr({ children, }) {
	return (
		<div className="relative flex items-center text-center justify-center hover:hue-rotate-[360deg] transition duration-[1s] ease-in-out  my-8 ">
			...
			{children && (
				<div className="mx-4 hover:px-10 transition-all px-4 py-2 bg-[#202020] text-[#c2e29c] text-sm font-bold uppercase shadow-md border border-[#c2e29c] rounded-full hover: ">
					{children}
				</div>
			)}
